...
**[Read the paper on SSRN](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=6456238)**

![Profit trajectory across 645 experiments](progress.png)
...
**645 experiments later, it closes the gap from 72.5% to 90.7% of the
...
doing a lot of work in that sentence when Valentine's Day demand is 7x a normal
Tuesday.

**Holidays are cliffs, not hills.** Rose demand doesn't gently rise into
Valentine's Day. It spikes 7x on the day, 4x the day before, then crashes
...
| Per-product tuning | $485,006 | 89.6% | Each flower gets its own parameters |
...
- **The Monday after Mother's Day** is the single biggest miss. Orchid and lily
  customers who couldn't buy on Sunday come back Monday. A 3.4x orchid boost
...
**Most experiments fail, and that's the point.** Of 645 experiments, 469 were
...
85.1% took a single experiment. The crawl from 85.1% to 90.7% took 644. This is the
...
├── results.tsv     # full experiment log (645 rows)
